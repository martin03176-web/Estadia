 ...
 <section class="hero">
    <div class="login-wrapper">
        ...
        <form method="POST" action="{{ $paciente->exists ? route('pacientes.update', $paciente) :route('pacientes.store') }}" class="login-form">
            ...
            <div class="form-group">
                <label for="incidente_id" :value="__('incidente_id')">
                    <i class="fa-solid fa-person-falling-burst"></i> Tipo de Incidente
                    <a href="http://localhost/laravel/estadia/public/registro_tipo_incidentes" type="button" class="btn btn-outline-secondary"><i class="fa-solid fa-circle-up"></i>Nuevo Tipo</a>
                </label>
                    <input type="text" id="incidente_id" list="incidente" class="form-control form-control-lg"
                           placeholder="Ingrese el Tipo de Incidente" >
                           <datalist id="incidente" >
                            <option value="Reporte de Riesgo">Reporte de Riesgo</option>
            ...
            <div class="form-group">
                <label for="tipo_riesgo_id" :value="__('tipo_riesgo_id')">
                    <i class="fa-solid fa-explosion"></i> Tipo de Riesgo
                    <a href="http://localhost/laravel/estadia/public/registro_tipo_riesgos" type="button" class="btn btn-outline-secondary"><i class="fa-solid fa-circle-up"></i>Nuevo Tipo</a>
                </label>
                    <input type="text" id="tipo_riesgo_id" list="tipo_riesgo" class="form-control form-control-lg"
                           placeholder="Ingrese el Tipo de Riesgo" required autofocus autocomplete="tipo_riesgo_id">
                           <datalist id="tipo_riesgo" >
                            ...
                            <option value="Socio Organizativo">Socio Organizativo</option>
            ...
            <div class="form-group">
                <label for="nivel_riesgo_id" :value="__('nivel_riesgo_id')">
                    <i class="fa-solid fa-skull-crossbones"></i> Nivel de Riesgo
                    <a href="http://localhost/laravel/estadia/public/registro_nivel_riesgos" type="button" class="btn btn-outline-secondary"><i class="fa-solid fa-circle-up"></i>Nuevo Nivel</a>
                </label>
                    <input type="text" id="nivel_riesgo_id" list="nivel_riesgo" class="form-control form-control-lg"
                           placeholder="Ingrese el Nivel de Riesgo" required autofocus autocomplete="nivel_riesgo_id">
                           <datalist id="nivel_riesgo" >
            ...
            <div class="form-group">
                <label for="material_equipo_id" :value="__('material_equipo_id')">
                    ...
                    <input type="text" id="material_equipo_id" list="material_equipo" class="form-control form-control-lg"
                           placeholder="Ingrese el Material o Equipo" required autofocus autocomplete="material_equipo_id">
                           <datalist id="material_equipo" >
                            <option value="Ninguno"></option>
                            <option value="Extintor"></option>
                            <option value="Botiquín de Primeros Auxilios"></option>
