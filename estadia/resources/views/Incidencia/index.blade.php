    ...
    <div class="login-wrapper">
        ...
        <div class="form-group">
            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                    <th scope="row">Derrame de ácido</th>
                    <td>03/12/2025</td>
                    <td>Laboratorio de química 3</td>
                    <td>Reporte de riesgo</td>
                    <td>Químico</td>
                    <td>Alto</td>
                    <td>Se acordonó el área</td>
                    <td><a  type="button" class="btn btn-outline-secondary"><i class="fa-solid fa-circle-up"></i>Actualizar</a></td>
                  </tr>
                  <tr>
                    <th scope="row">Manifestación</th>
                    <td>03/09/2025</td>
                    <td>Taller Mecánico B</td>
                    <td>Emergencia</td>
                    <td>Socio organizativo</td>
                    <td>Alto</td>
                    <td>Manifestación y atención por golpe</td>
                    <td><a  type="button" class="btn btn-outline-secondary"><i class="fa-solid fa-circle-up"></i>Actualizar</a></td>
                  </tr>
