...
@section('estilos')
<link rel="stylesheet" href="{{asset('assets/css/inicio10.css')}}">    
@endsection
...
@section('menu')
    ...
    <nav class="main-nav" id="mainNav">
        ...
        <div class="nav-item">
            ...
            <div class="submenu">
                <a href="{{ route('atencions.create') }}" class="submenu-link">
                    <i class="fa-regular fa-pen-to-square"></i> Atender Paciente
                </a>
                <a href="{{ route('pacientes.index') }}" class="submenu-link">
                    <i class="fas fa-list"></i> Lista de Pacientes
                </a>
                <a href="{{ route('atencions.index') }}" class="submenu-link">
