        ...
        <form method="POST" action="{{ route('register') }}" class="login-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" :value="old('name')"
                       placeholder="Ingrese el Nombre del Responsable " required autofocus autocomplete="name">
                       @error('name')     
                    <div class="logo-text">
                        <p>{{$message}}</p> 
                    </div>
            ...
            <div class="form-group">
                <label for="area" :value="__('Area')">
                    <i class="fa-solid fa-qrcode"></i> Puesto o Áreas
                </label>
                <input type="text" id="area" name="area" :value="old('area')"
                       placeholder="Ingrese el Puesto o Área" required autofocus autocomplete="area">
                       @error('area')     
                    <div class="logo-text">
                        <p>{{$message}}</p> 
                    </div>
            ...
            <div class="form-group">
                <label for="nota" :value="__('Nota')">
                    <i class="fa-solid fa-book-bookmark"></i> Nota (opcional)
                </label>
                <input type="text" id="nota" name="nota" :value="old('nota')"
                       placeholder="..." required autofocus autocomplete="nota">
                       @error('nota')     
                    <div class="logo-text">
                        <p>{{$message}}</p> 
                    </div>
