...
@section('titulo', 'Atención de mantenimiento')

@section('contenido')
<section class="hero">
    <div class="login-wrapper-M">
        <div class="logo-text">
            <h1>Atención de Mantenimiento</h1>
        </div>
        ...
        <form method="POST" action="{{ $atencion->exists ? route('atenciones.update', $atencion) : route('atenciones.store') }}" class="login-form">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" id="hora_atencion" name="hora_atencion" value="{{ old('hora_atencion', $atencion->hora_atencion) }}"
